...
public class Main {
    public static void main(String[] args) {
        ...
        category1.addProduct(new Product("Стиральная машинка", 35000.0, 4));
        category1.addProduct(new Product("Смартфон", 21000.0, 5));

        Category category2 = new Category("Одежда");
        category2.addProduct(new Product("Штаны", 1500.0, 3));
        category2.addProduct(new Product("Кепка", 300.0, 4));
